...
/*
var myButton = widgets.NewQPushButton2("NewButton");
myButton.SetObjectName("myNewButton");
myButton.ConnectClicked(function(){ alert("you clicked " + myButton.ObjectName()) });
layout.AddWidget2(myButton, 2, 1, 0);
*/

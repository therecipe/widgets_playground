...
func (i *TreeItem) setData(column int, data string) {
	i._itemData[column] = data
}
...
func (m *CustomTreeModel) setData(index *core.QModelIndex, value *core.QVariant, role int) bool {
	if !index.IsValid() {
		return false
	}
...
func (m *CustomTreeModel) flags(index *core.QModelIndex) core.Qt__ItemFlag {
	if !index.IsValid() {
...
func newTreeView() *widgets.QWidget {
